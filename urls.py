...
urlpatterns = [path("index.html", views.index, name="index"),
	       ...
	       path("StudentScreen", views.StudentScreen, name="StudentScreen"),
	       path("Feedback.html", views.Feedback, name="Feedback"),
	       path("FeedbackAction", views.FeedbackAction, name="FeedbackAction"),
	       path("ViewMarksAction", views.ViewMarksAction, name="ViewMarksAction"),
	       path("ChooseFaculty.html", views.ChooseFaculty, name="ChooseFaculty"),
	       path("FacultySuggestion", views.FacultySuggestion, name="FacultySuggestion"),
	       path("AutoFacultySelection", views.AutoFacultySelection, name="AutoFacultySelection"),
]
